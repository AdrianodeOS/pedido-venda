...
public class PersistenceProperties {
	...
	public Properties get() {
		...
		try {
			...
			// Se esse método (systemEnv) retornar alguma propriedade, igual a
			...
			// Se esse método (javaPropertyJdbcFile()) retornar alguma
			// propriedade, igual a que o método anterior

			// tenha configurado, ela irá prevalecer.

			props.putAll(javaPropertyJdbcFile());

			// Se esse método (javaProperties()) retornar alguma propriedade,
			// igual a que o método anterior
	 ...
	 * dos valores
	 * 
	 * das propriedades estáticas {@link #JDBC_URL}, {@link #JDBC_USER} e
	 ...
	 * aplicação. Esse
	 * 
	 * parâmetro deve se chamar "jdbc-file", portanto será passado dessa forma
	 * "-Djdbc-file=/caminho/jdbc.properites".
	 * 
	 * 
	 * 
	 * A chave das propriedades desse arquivo devem ser iguais ao nome da
